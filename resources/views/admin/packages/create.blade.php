    ...
    <div class="bg-white rounded-xl shadow-sm border p-6">
        ...
        <form action="{{ route('admin.packages.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="number" name="email_limit" value="{{ old('email_limit') }}" class="w-full mt-1 border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
            ...
            <div>
                ...
                <div class="relative mt-1">
                    ...
                    <input type="number" name="price_ngn" value="{{ old('price_ngn') }}" class="w-full pl-7 border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                </div>
            </div>

            <div class="flex justify-end gap-3 pt-6 border-t">
                <a href="{{ route('admin.packages.index') }}" class="text-gray-500 px-4 py-2 text-sm font-bold hover:text-gray-800 transition">
                    Cancel
                </a>
